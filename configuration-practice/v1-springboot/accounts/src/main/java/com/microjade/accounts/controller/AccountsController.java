...
import com.microjade.accounts.dto.AccountsContactInfoDto;
...
@Tag(
        ...
        description = "CRUD REST APIs in Project to CREATE, UPDATE, GET AND DELETE account details"
)
@RestController
@RequestMapping(path = "/api/account",produces = {MediaType.APPLICATION_JSON_VALUE})
//@AllArgsConstructor No lo podemos usar ya que tenemos String buildVersion que no se puede inyectar
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside the project"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to get Customer & Account details on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to update Customer & Account details on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to delete Customer & Account details on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "GET Build info about REST API",
